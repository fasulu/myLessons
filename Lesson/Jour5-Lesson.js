...
// si myOperatorString == "+" => je fais une addition normal de javascript 
    // comme on avait vu dans le jour 2 du module
console.log(6 + 14)
...
// Require js file avec functions
...
// console.log("Thank you for helping to practice my code, here in return I 
// five you a randome number dice", launchSimpleDice())
console.log("Thank you for helping to practice my code, here in return I five you");
console.log(launchComplexDice(2, 10));


// Outils/normal Fountion
